...
def crear_clientes_varios(request):
    ...
    p2.save()
    p3.save()
    c1 = models.Cliente(nombre="Britney", apellido="William", nacimiento=date(2015, 1, 1), pais_origen=p1)
    c2 = models.Cliente(nombre="Pedro", apellido="Reyes", nacimiento=date(2005, 2, 2), pais_origen=p2)
    c3 = models.Cliente(nombre="Alex", apellido="peres", nacimiento=date(1990, 1, 1), pais_origen=p3)
    c4 = models.Cliente(nombre="Jhoana", apellido="Cruz", nacimiento=date(2005, 1, 1), pais_origen=None)
    c1.save()
    c2.save()
    c3.save()
    c4.save()
